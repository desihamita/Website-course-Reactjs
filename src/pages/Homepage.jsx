    ...
    <div className="homepage">
        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit quia reiciendis, itaque doloribus similique quod.</p>
              ...
              <button className="btn btn-outline-danger btn-lg rounded-1 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s">Lihat Promo Menarik</button>
            </Col>
            <Col lg="6" className="pt-lg-0 pt-5">
              <img src={HeroImg} alt="hero-img" className="animate__animated animate__fadeInUp"/>
            </Col>
          </Row>
        </Container>
      </header>
      <div className="kelas w-100 min-vh-100">
        <Container>
          <Row>
            <Col>
              <h1 className="text-center font-weight-bold">Kelas Terbaru</h1>
            ...
            {kelasTerbaru.map((kelas) => {
              ...
              <Col key={kelas.id} className="shadow rounded" data-aos="fade-up" data-aos-duration="1000" data-aos-delay={kelas.delay}>
                ...
                <div className="ket d-flex justify-content-between align-items-center px-3 pb-3">
                  <p className="m-0 text-primary font-weight-bold">{kelas.price}</p>
      ...
      <div className="testimonial">
        <Container>
          <Row>
            <Col>
              <h1 className="text-center font-weight-bold my-5">Testimonial</h1>
            </Col>
          </Row>
          <Row>
            <Swiper
            ...
            >
              {dataSwiper.map((data) => {
                return (
                  <SwiperSlide key={data.id} className="shadow-sm m-2">
